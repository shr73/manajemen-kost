                ...
                <div class="card-body">
                    <form action="{{ route('gedung.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label for="id">ID Gedung <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="id_gedung" id="id" placeholder="Masukkan ID Gedung" required>
                        </div>
                        <div class="form-group">
                            <label for="nama_gedung">Nama Gedung <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="nama_gedung" id="nama_gedung" placeholder="Masukkan Nama Gedung" required>
                        </div>
                        <br>
                        <div>
